...
def write_tiny_example(
    ...
    ParameterSet({"Scenario name": spec.name, "Generated by": "ebolasim"}).write(preparameter_file)
    ...
    (target / "README.md").write_text(
        (
            "# TinyDistrict\n\n"
            "A small, synthetic, not-calibrated example for exercising the C model executable.\n"
        ),
        encoding="utf-8",
    )
    files = sorted(
